...
class M6502Low : public M6502
{
  ...
  public:
    ...
    */
    ...
    virtual void illegal_op(uInt8 operand);

    // Optional tiny smolnes-derived core (compiled when -DUSE_SMOLNES_CPU).
    virtual void execute_smol(void);
    // Instruction-level A/B comparison driver (compiled when -DSTELLA_DUAL_CPU).
    virtual void execute_compare(void);
